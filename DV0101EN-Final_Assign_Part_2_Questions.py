...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_effect = data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
...
#TASK 2.6: Returning the graphs for display
        return [
            html.Div(className='chart-item', children=[html.Div(children=Y_chart1), html.Div(children=R_chart1)],
             style={'display': 'flex', 'flex-direction': 'row'}),
            html.Div(className='chart-item', children=[html.Div(children=Y_chart2), html.Div(children=R_chart2)],
             style={'display': 'flex', 'flex-direction': 'row'}),
            html.Div(className='chart-item', children=[html.Div(children=Y_chart3), html.Div(children=R_chart3)],
             style={'display': 'flex', 'flex-direction': 'row'}),
            html.Div(className='chart-item', children=[html.Div(children=Y_chart4), html.Div(children=R_chart4)],
             style={'display': 'flex', 'flex-direction': 'row'})
]
